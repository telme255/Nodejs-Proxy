...
const UUID = process.env.UUID || '7f9f7de7-2102-48d2-8de8-faa5c7595c7e';  //UUID,可替换
const uuid = UUID.replace(/-/g, "");
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'www.Google.com';   //哪吒面板服务器地址，没有可空
const NEZHA_PORT = process.env.NEZHA_PORT || '443';        // 端口为443时自动开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || '';             // 哪吒三个变量，没有可空
const DOMAIN = process.env.DOMAIN || 'www.Google.com';  // 项目域名或已反代的域名
const NAME = process.env.NAME || '代理节点';
const port = process.env.PORT || 33000;  //端口号，如有冲突请更换不同端口号
